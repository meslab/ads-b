...
const int ADSB_RATE	= 2000000;
const int ADSB_FREQ = 1090000000;
const int DEFAULT_ASYNC_BUF_NUMBER = 12;
const int DEFAULT_BUF_LENGTH = (16 * 16384);
const int AUTO_GAIN = -100;

const int MESSAGEGO = 253;
const int OVERWRITE = 254;
const int BADSAMPLE = 255;
